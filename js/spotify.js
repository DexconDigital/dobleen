    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            seccion_audio.html('<div class="row aud-bg-gris rounded-lg">' +
                '<div class="col-xl-2 col-lg-3 col-md-3 col-12 p-3 d-flex justify-content-center">' +
                '<img src="' + dato.thumbnail + '" class="img-fluid w-10-rem rounded-lg shadow" alt="...">' +
                '</div>' +
                '<div class="col-xl-10 col-lg-9 col-md-9 col-12 p-3">' +
                '<h5 class="fm-regular font-weight-bold text-light mb-0 mt-3">' + dato.title + '</h5>' +
            ...
            siguiente.click(function (e) {
                ...
                sig_text.text(data.items[nuevo].title);
                ant_text.text(data.items[viejo].title);
